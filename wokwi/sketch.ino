/*
  ============================================================
  EstufaIoT - Versão para simulação no Wokwi
  ------------------------------------------------------------
  Mesma lógica do firmware real (firmware/EstufaIoT.ino), só
  trocando a rede Wi-Fi pela rede virtual do Wokwi, que já tem
  acesso à internet de verdade dentro do simulador.

  Dica: durante a simulação, clique no componente DHT22 no
  diagrama para abrir os controles e mudar manualmente a
  "temperature" - é assim que você demonstra o ventilador
  ligando sozinho acima de 28°C e o alarme acima de 35°C, sem
  precisar de calor de verdade.
  ============================================================
*/
...
// ---------------------- CONFIGURAÇÕES ----------------------
const char* WIFI_SSID     = "Wokwi-GUEST";  // rede virtual do simulador
const char* WIFI_PASSWORD = "";              // sem senha

const char* MQTT_BROKER = "broker.hivemq.com";
const int   MQTT_PORT   = 1883;
const char* MQTT_CLIENT_ID = "esp32-estufa-wokwi";

// Tópicos - mesmos usados pelo backend (server.js)
...
const float TEMP_LIMITE_FAN    = 28.0;
const float TEMP_LIMITE_ALARME = 35.0;
...
bool fanLigadoManual = false;
bool fanForcado = false;
bool ledLigado = false;

// ---------------------- WIFI ----------------------
void conectarWiFi() {
  Serial.print("Conectando ao WiFi (Wokwi-GUEST)");
